...
#include <kobuki_controller_tutorial/bump_blink_controller.h>
...
public:
	 ...
	 * 
	 * This function is called, when the nodelet manager loads
	 * the nodelet.
	 */
	...
	virtual void onInit() {
		...
		if (controller_->init())
			...
			NODELET_INFO_STREAM("Couldn't initialise nodelet! Please restart. [" <<
				name << "]");
	}
