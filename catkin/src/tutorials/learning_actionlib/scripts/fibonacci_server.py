...
class FibonacciAction(object):
	...
	_feedback = learning_actionlib.msg.FibonacciFeedback()
	_result = learning_actionlib.msg.FibonacciResult()
	...
	def execute_cb(self, goal):
		...
		rospy.loginfo("%s: Executing, creating fibonacci sequence of order %i with seeds %i, %i" \
			% (self._action_name, goal.order, self._feedback.sequence[0],
		...
		for i in xrange(1, goal.order):
			...
			# this step is not necessary, the sequence is computed at 1 Hz
