...
if("FALSE" STREQUAL "TRUE")
  set(openni2_launch_SOURCE_PREFIX /tmp/buildd/ros-indigo-openni2-launch-0.2.2-0trusty-20150329-1325)
  set(openni2_launch_DEVEL_PREFIX /tmp/buildd/ros-indigo-openni2-launch-0.2.2-0trusty-20150329-1325/obj-x86_64-linux-gnu/devel)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'openni2_launch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Michael Ferguson <developers@unboundedrobotics.com>' to fix it.")
    endif()
